...
```text
https://ijudge.it.kmitl.ac.th/submissions/641918/overview
```
...
```text
Input: ค่า N, K, T โดยให้คนแรกตรวจของขวัญและส่งต่อไปโดยจำนวน K

Output: จำนวนคนที่ได้ตรวจของขวัญ

Constraints: สูตรการเดินเป็นวงกลม
```
...
```text
Step1: สร้าง list ของคนที่ได้ทำการตรวจของขวัญไปแล้ว
Step2: ทำการวนการตรวจไปเรื่อยๆ จนกว่าจำไปถึงมือคนขโมยหรือกลับไปหาคนแรก
Step3: เมื่อตรงตามเงื่อนไขให้หยุดและพิมพ์บอกจำนวนคนที่เคยตรวจ โดยใช้เป็น len(list)
```
...
```text
เปลี่ยนจาก list เป็น set เพราะว่าถ้าใช้เป็น list มันจะกินเวลาและ และต้องสร้างตัวตรวจเงื่อนไขเผื่อคนขโมยคือคนแรก
```
