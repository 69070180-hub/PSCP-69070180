...
```text
https://ijudge.it.kmitl.ac.th/submissions/566316/overview
```
...
```text
input1: ตัวเลขจำนวนจริง เป็นค่าอุณหภูมิ
input2: ตัวอักษรที่เป็นหน่วยอุณหภูมิใน input1 โดยมี ฟาเรนไฮต์ (F), เคลวิน (K), และแรงคิน (R) จากหน่วยเซลเซียส (C)
input3: ตัวอักษรที่เป็นหน่วยอุณหภูมิอีกตัว

output: เปลี่ยนค่าอุณหภูมิที่ได้ เป็นในหน่วยอุณภูมิใน input3

constraints: จะต้องทำ if elif ให้รองรับกับทุกสูตร
```
...
```text
Step1: ปรับค่าที่ได้มาให้เป็น เซลเซียส ถ้าเป็น เซลเซียส อยู่แล้วก็ให้เป็นค่าเดิม
Step2: ปรับค่าให้ เซลเซียส  ที่ได้มาแล้วเป็นค่าที่ต้องการและปริ้นเป็นทศนิยมสองตำแหน่ง
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ใช้ if elif เปลี่ยนเป็น เซลเซียส แล้วค่อยเปลี่ยนเป็นค่าที่ต้องการ
```
...
```text
เข็คว่าการเปลี่ยนเป็นทศนิยมทำงานไหม
```
