...
```text
https://ijudge.it.kmitl.ac.th/submissions/560542/overview
```
...
```text
Input: รับตัวอักษรที่ต้องเป็นคำว่า(Red , Yellow , Blue)
Input2: รับตัวอักษรที่ต้องเป็นคำว่า(Red , Yellow , Blue)

Output: เป็นสีที่เกิดจากการใช้สีทั้งสองผสมกัน(Orange , Violet , Green)

Constraints: input ต้องเป็นเพียงแค่สามสีที่กล่าวมาเท่านั้น
```
...
```text
Step1: ให้เช็คว่าว่าคำทั้งสองตรงกับเงื่อนไขใด
Step2: ถ้าตรงตามเงื่อนไขใดเงื่อนหนึ่ง ให้พิมพ์คำที่ระบุไว้ออกมา
Step3: หากเป็น "Red" and "Yellow" ให้พิมพ์ "Orange"
Step4: ถ้าเป็น "Red" and "Blue" ให้พิมพ์ "Violet"
Step5: ถ้าเป็น "Blue" and "Yellow" ให้พิมพ์ "Green"
Step6: ถ้าสีทั้งสามสีนั้นผสมตัวมันเอง ให้พิมพ์เป็นสีเดิมออกมา
Step7: แต่ถ้าไม่ตรงตามเงื่อนไขใดเลย ให้พิมพ์ "Error"
```
...
```text
เช็คว่าถ้าสีผสมตัวมันเองจะได้ออกมาเป็นสีนั้นไหม
```
