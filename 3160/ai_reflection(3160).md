...
| OJ submission ID, if submitted | https://ijudge.it.kmitl.ac.th/submissions/642113/overview |
| OJ status | Pass |
...
```text
สอนฉันในการใช้โค้ด def is_prime(num)
```
...
```text
ฉันยังคงเขียน loop ในตรวจจับเพื่อนำเข้า list และพิมพ์ออกมา
```
...
```text
ฉันได้รู้ถึงวิธีการหาจำนวนเฉพาะ
```
