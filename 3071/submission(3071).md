...
```text
https://ijudge.it.kmitl.ac.th/submissions/631747/overview
```
...
output: บอกจำนวนเลขระหว่าง AถึงB ว่าถ้าหากหาร d แล้วได้เศษ r มีกี่ตัว

constraints: ต้องหาวีธีในตรวจจับและนับ
```
...
```text
Step1: ทำการให้ A หาร d ไปเรื่อยๆ จนถึง B
Step2: ให้ทำการตรวจ หากจำนวนนั้นหาร d และมีเศษเท่ากับ r ให้นับหนึ่ง
Step3: ปริ้นจำนวนที่นับได้
```
