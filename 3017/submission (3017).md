...
```text
https://ijudge.it.kmitl.ac.th/submissions/560553/overview
```
...
```text
Input: ค่าตัวเลขจำนวนนึง ที่เป็นราคาของอาหารที่กิน

Output: จำนวนเงินทั้งหมดที่ต้องจ่ายหลังนำค่าอาหารไปบวกกับค่า service charge และ VAT แล้ว

Constraints: ต้องปรับให้ค่า service charge อย่างต่ำอยู่ที่ 50 และอย่างมากอยู่ที่ 1000
```
...
```text
Step1: นำราคาอาหารมาคำนวณหาค่า service charge โดยการคูณ 0.1 เพราะค่า service charge คือ 10% ของราคาอาหาร
Step2: นำราคา service charge ที่ได้มาปรับโดยถ้าหากค่า service charge ที่คำนวณออกมาได้ต่ำกว่า 50 ให้ปรับเป็น 50 และ ถ้าค่า service charge ที่คำนวณออกมามากกว่า 1000 ให้ปรับเป็น 1000
Step3: นำค่า service charge ที่หาได้มาบวกกับราคาอาหารจะขอเรียกค่านี่ว่า sub_now
Step4: นำค่า sub_now มาคำนวณหาค่า VAT โดยการเอา sub_now มาคูณ 0.07 เพราะค่า VAT คือ 7%
Step5: หลังได้ค่า VAT แล้วก็เอามาบวกกับ sub_now ก็จะได้เป็นจำนวนเงินทั้งหมดที่ต้องจ่าย
Step6: print จำนวนเงินทั้งหมด โดยให้อยู่ในรูปของทศนิยมสองตำแหน่ง
```
...
```text
เช็คว่าเหมือนกับ Test case ที่ระบุไว้ในหน้าเว็บไหม
```
...
```text
เช็คว่าการปรับ Service Charge ทำงานจริงๆ
```
