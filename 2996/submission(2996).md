...
```text
https://ijudge.it.kmitl.ac.th/submissions/560536/overview
```
...
```text
Input: รับค่าเป็นตัวอักษร

Output: ทำให้ตัวอักษรเป็นตัวเล็กทั้งหมด แล้วสลับตัวอักษรจากหน้าไปหลัง 
```
...
```text
Step1: เปลี่ยนให้ตัวอักษรสลับจากหลังไปหน้า และหน้่าไปหลัง
Step2: print ออกมาโดยให้เป็นตัวอักษรพิมพ์เล็กทั้งหมด

ได้มีการค้นหาว่าต้องเขียนยังไง ให้ตัวอักษรเกิดการสลับ
```
...
```text
เหมือนแผ่นแรก แค่เปลี่ยนให้ตัวอักษรที่รับมาสลับหน้าไปหลัง และหลังไปหน้า แล้วจึงค่อย print ออกมาเป็นตัวเล็ก
```
...
```text
หาว่าต้องเขียนยังไงให้เกิดการสลับ
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนเองหมดแล้วใช้ text[::-1] ตามที่หาเจอ
```
