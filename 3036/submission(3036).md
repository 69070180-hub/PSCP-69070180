...
```text
input: รับค่าจำนวนเต็ม n

output: จำนวนกำแพงที่ต้องผ่านไป

Constraints: ต้องมองหาแพทเทิร์น และคำนวณหาสูตรของจำนวนการผ่านกำแพง
```
...
```text
Step1: ต้องหาให้ได้ว่า n อยู่ชั้นที่เท่าไหร่ของปราสาท
Step2: โดยรูปแบบจำนวนห้องในชั้นของปราสาทคือ a^2  เพราะฉะนั้นถ้า n=11 ; 3^2 < 11 <= 4^2 แสดงว่า n อยู่ชั้นที่ 4
Step3: หาว่า n อยู่ตำแหน่งที่เท่าไหร่ของชั้นนั้น เช่น 11 อยู่ตำแหน่งที่ 2 ของชั้น4 โดยใช้สูตร position = n - (a - 1) ** 2
Step4: หากตำแหน่งเป็นเลขคี่ให้ใช้เป็น (a - 1) * 2 ถ้่าเป็นเลขคู่ใช้ (a - 1) * 2 - 1
```
...
```text
หาว่าอะไรที่ใช้ในการหาค่ารากที่สองของตัวเลข และปัดเลขขึ้นถ้ามีทศนิยม
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ดเอง และคำนวณหาสูตรเอง
```
