...
```text
https://ijudge.it.kmitl.ac.th/submissions/631834/overview
```
...
output: นับว่าสระแต่ละตัวมีกี่ตัว

constraints: หาวิธีในการนับ และปริ้นออกมาแล้วบอกแค่สระที่มีว่ามีกี่ตัว
```
...
```text
Step1: ทำตัวตรวจจับสระ
Step2: ให้ loop ทำการนับว่าสระที่กำหนดอยู่ในคำกี่ตัว
Step3: ปริ้นสระที่มีและจำนวนของมัน
```
...
```text
wecnwlenflwrvd;lkanvrjwanvjahdshfew3802oufhkrwbvkajw
```
