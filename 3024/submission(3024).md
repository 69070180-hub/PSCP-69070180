...
```text
https://ijudge.it.kmitl.ac.th/submissions/586923/overview
```
...
```text
Input1: รับคะแนนรวมของคนสามคนเป็นจำนวนเต็ม
Input2: รับคะแนนสูงสุด

Output: พิมพ์ "Surprising" หากคะแนนต่ำสุดและสูงสุดห่างกันเกิน 2. พิมพ์ "Not surprising" หากคะแนนต่ำสุดและสูงสุดห่างกันไม่เกิน 2

Constraints: ต้องหาวิธีการหาคะแนนที่ต่ำสุดเพราะไม่ทราบคะแนนของคนอีกคน
```
...
```text
Step1: หากไม่ทราบว่าคะแนนของคนอีกคน ก็ตีให้คะแนนอีกคนเท่ากับคะแนนมากสุดเพราะเราจะเอาคะแนนต่ำสุดที่เป็นไปได้
Step2: นำคะแนนสูงสุดมาคูณสอง แล้วมาลบคะแนนทั้งหมดเพื่อเอาคะแนนต่ำสุด
Step3: นำคะแนนสูงสุดลบต่ำสุด เพื่อหาความแตกต่าง
Step4: หากคำแนนห่างกันไม่เกิน 2 ให้พิมพ์ "Not surprising"
Step5: หากคำแนนห่างกันเกิน 2 ให้พิมพ์ "Surprising"
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก แต่ปรับแก้เพราะลืมไปว่าหากสูตร "คะแนนต่ำสุด = คะแนนรวม - (คะแนนสูงสุด * 2)" แล้วผลคะแนนต่ำสุดได้ออกมาต่ำกว่า 0 จะไปพังตอนท้ายเลยต้องปรับให้ คะแนนต่ำสุดเป็น 0 เมื่อผลที่ออกมาต่ำกว่า 0
```
...
```text
เช็คว่ามันจะปรับ Lowest เป็น 0 ไหม
```
