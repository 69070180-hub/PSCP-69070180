...
```text
https://ijudge.it.kmitl.ac.th/submissions/641557/overview
```
...
```text
Input: รับค่า n เพื่อเป็นจำนวน input ตามตำนวน n

Output: พิมพ์ค่าตามเงื่อนไขที่ได้รับ

Constraints: ทำการตรวจสอบเงื่อนไขใน loop
```
...
```text
Step1: รับค่า n และเปิด loop ตามจำนวน n
Step2: หาก input() เป็น + ให้ +10
Step3: หาก input() เป็น - ให้ -5
Step4: พิมพ์ค่าที่ได้หลังจากการบวกลบแล้ว
```
