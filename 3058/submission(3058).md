...
```text
https://ijudge.it.kmitl.ac.th/submissions/608779/overview
```
...
```text
input1: รับจำนวนอิฐที่แบบก้อนเล็ก
input2:  รับจำนวนอิฐที่แบบก้อนใหญ่
input3: ความยาวของสะพานที่ต้องสร้าง

output: จำนวนอิฐก่อนเล็กที่ต้องใช้ในการสร้างสะพาน

constraints: ต้องหาวิธีคิดให้หาขนาดจำนวนอิฐเล็กที่ต้องใช้หลังใช้อิฐใหญ่ไปแล้ว
```
...
```text
Step1: ตรวจหาว่ามีการใช้อิฐก่อนใหญ่ไปเท่าไหร่
Step2: หลังได้จำนวนอิฐก่อนใหญ่ที่ใช้ไป ก็ตรวจว่าเหลืออีกกี่นิ้วถึงสะพานจะเสร็จ
Step3: ถ้าเกิดว่าจำนวนที่เหลืออยู่เยอะกว่าอิฐเล็กที่มี ให้พิมพ์ "-1"
Step4: ถ้าเกิดว่าจำนวนที่เหลืออยู่น้อยกว่าอิฐเล็กที่มี ให้พิมพ์ "จำนวนนิ้วที่เหลืออยู่"
```
...
```text
ตรวจว่าถ้าแค่ใช้อิฐใหญ่ก็พอแล้ว จะเป็นยังไง
```
