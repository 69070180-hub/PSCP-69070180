...
```text
https://ijudge.it.kmitl.ac.th/submissions/632374/overview
```
...
```text
input: จุดหมายต้นทางและปลายทาง
input2: น้ำหนักของสิ่งของที่จัดส่ง

output: ราคาที่ต้องจ่าย

constraints: เป็นการเขียน if else ให้ตรงตามเงื่อนไข
```
...
```text
Step1: เขียน if elif ของทุกเส้นทางที่กำหนดมา
Step2: เติมการคำนวณราคาของแต่ละเส้นทาง
Step3: พิมพ์ราคาที่คำนวณมาแล้ว
```
...
```text
ลองถ้าเส้นทางไม่เป็นไปตามตาราง
```
