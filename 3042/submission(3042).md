...
```text
https://ijudge.it.kmitl.ac.th/submissions/566314/overview
```
...
```text
input: รับค่าจำนวนเต็มบวก N

output: แสดงเลขที่หาร 10 ลงตัวโดยเริ่มจาก N แล้วลดลงที่ละ 10 จนถึง 0

constraints: จะต้องเปลี่ยนค่า N ให้เป็นเลขที่หาร 10 ลงตัวให้ได้
```
...
```text
Step1: ปรับค่าที่รับมาให้เป็นเลขหลักสิบโดย
Step2: พิมพ์เลขที่ปรับมาแล้ว และลดลงที่ 10 จนถึง 0
```
...
```text
ตรวจว่าการลดลงที่ละ 10 ทำงานไหม
```
...
```text
ตรวจว่าการปรับเลขให้เป็นเลขที่หาร 10 ลงตัวทำงานไหม
```
