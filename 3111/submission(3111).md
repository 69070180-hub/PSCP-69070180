...
```text
https://ijudge.it.kmitl.ac.th/submissions/632533/overview
```
...
```text
input1: การตรวจสอบว่าเป็นสมาชิกไหมโดยใช้ "Y" หรือ "N"
input2: จำนวนราคาสินค้าที่จะซื้อ
input3: ราคาสินค้าแต่ละชิ้นตามจำนวนใน input2

output: ราคาที่ต้องจ่ายหลังคำนวณจากการเป็นสมาชิกแล้ว

constraints: เขียน if else ตามเงื่อนไขที่กำหนดมาแล้ว
```
...
```text
Step1: ตรวจจับว่าเป็นสมาชิกไหม ถ้าเป็นให้ลด 5% 
Step2: ถ้าไม่ใช่สมาชิก แต่ซื้อของตั้งแต่ 500 ขึ้นไปได้ลด 3%
Step3: ถ้าไม่ใช่สมาชิกและซื้อไม่เกิน 500 จ่ายราคาเต็ม
Step4: ปรับให้เศษทศนิยมขึ้น และพิมพ์ออกมาให้เป็นทศนิยม 2 ตำแหน่ง
```
...
```text
ลองถ้าตัวอักษรอยู่นอกเหนือ Y และ N
```
